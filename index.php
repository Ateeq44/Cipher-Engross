															...
															<div class="post-desc bg-dark desc-hero text-left">
																<div class="post-desc-inner">
																	...
																	<h3 class="entry-title h3">
																		<a class="title-text" href="2023/09/06/winter-dressing-tips-when-its-really-cold-out/index.html" title="Winter Dressing Tips When It&#8217;s Really Cold Out">
																			<?php the_title() ?>
																		</a>
																	</h3>
																</div>
																<div class="entry-meta no-icons">
																	<div class="meta-item meta-author author vcard meta-color">
																		<a href="author/admin/index.html" class="info-text author-name url fn" rel="author" title="Posts by John Doe">
																			<?php the_author() ?>
																		</a>
																	</div>
																	<div class="meta-item meta-date">
															...
															<article class="post-layout group4 post-small format-standard">
																...
																<div class="post-small-desc">
																	<div class="entry-header">
																		...
																		<h3 class="entry-title h6">
																			<a class="title-text" href="2023/09/06/top-mens-fashion-trends-from-spring/index.html" title="Top Men&#8217;s Fashion Trends From Spring"><?php the_title() ?></a>
																		</h3>
																	</div>
																</div>
															</article>
															...
															<article class="post-layout group2 post-medium format-standard">
																...
																<div class="post-desc text-left">
																	<div class="post-desc-inner">
																		<div class="entry-header">
																			<div class="entry-cats">
																				<a class="post-cat info-text cat-text post-cat-1" href="category/style/index.html"><?php the_category() ?>
																			</a>
																		</div>
																		<h3 class="entry-title h4">
																			<a class="title-text" href="2023/09/06/winter-dressing-tips-when-its-really-cold-out/index.html" title="Winter Dressing Tips When It&#8217;s Really Cold Out"><?php the_title() ?></a>
																		</h3>
																	</div>
																	<div class="entry-meta no-icons">
																		<div class="meta-item meta-author author vcard meta-color">
												...
												while ($query->have_posts()) : $query->the_post();
													...
													<div class="post-item cat-1">
														<article class="post-layout small1 post-small format-standard">
															<div class="post-small-thumbnail">
																<div class="entry-thumbnail">
																	<a class="src-1_1" href="" title="Winter Dressing Tips When It&#8217;s Really Cold Out">
																		<div class="thumb-container thumb-100">
															...
															<div class="post-small-desc">
																<div class="entry-header">
																	<h3 class="entry-title h6">
																		<a class="title-text" href="2023/09/06/winter-dressing-tips-when-its-really-cold-out/index.html" title="">
																			<?php the_title() ?>
																		</a>
																	</h3>
																</div>
											...
											<div class="term-item term-1">
												<div class="post-hero">
													...
													<div class="post-desc bg-dark desc-hero">
														<a class="hero-link" href="<?php echo get_category_link(get_cat_ID('')); ?>" title="Style"></a>
														<div class="term-desc">
